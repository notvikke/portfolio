...
AI-Powered AWS Security Monitoring & Autonomous Remediation system using Claude Sonnet 4.
...
- **Backend**: AWS CDK, Python, AWS Lambda, Amazon Bedrock, DynamoDB
- **Frontend**: Next.js 15, TypeScript, TailwindCSS, AWS Amplify
